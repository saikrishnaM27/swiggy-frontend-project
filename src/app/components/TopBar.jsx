...
const TopBar = () => {
    return (
        <section className='navBar d-flex justify-content-around align-items-center shadow-sm p-2 position-sticky top-0 bg-white z-1'>
            <div className="logo d-flex">
                <Link to="/">
                    <h2 className="text-danger">SWIGGY  </h2>
            ...
            <div className="searchBar input-group w-25">
                <input type='text' className="form-control" placeholder="Search here ..." />
                <button type='button' className='btn btn-danger bi bi-search'></button>
            </div>
            <div className="userAuth bi bi-person-circle fs-4">
                {/* <span className="fs-5">Login / SignUp</span> */}
            </div>
        </section>
    )
}
